...
# ========== 提示词注册模块导入（统一功能模块） ==========
from Lib.prompts.prompt_registry import register_prompts
# ========================================

# 创建 FastMCP 实例
mcp = FastMCP(
    "KazeMiMiRin的MCP工具集",  # 【猫娘修改】将服务器名称更改为“KazeMiMiRin的MCP工具集”。【修改时间】：2026-05-14 21:17:30。
    host="127.0.0.1",
    port=58001,
    stateless_http=True,
    json_response=True,
...
def main():
    ...
    register_prompts(mcp)  # 【猫娘修改】：委托提示词注册模块
    total = registered + failed

    print(f"\n{'='*60}")
    print("KazeMiMiRin的MCP工具集 Started")  # 【猫娘修改】将启动日志名称更改为“KazeMiMiRin的MCP工具集”。【修改时间】：2026-05-14 21:17:30。
    print(f"Address: 127.0.0.1:58001")
