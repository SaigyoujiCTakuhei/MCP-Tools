...
@tool(
    name="explain_fitness",
    description="Get detailed fitness breakdown with explanations. Returns score breakdown.",
    schema={
        "type": "object",
        "properties": {
...
def explain_fitness(
    ...
    # 获取状态管理器
    from Lib.evolution.evolve_core import get_state_manager, TestResults
    ...
    explanation = state_mgr.evaluator.explain_fitness(variant, results)
